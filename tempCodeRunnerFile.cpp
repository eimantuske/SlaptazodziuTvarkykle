...
int gautiPasirinkima() {
 ...
 void Pasirinkimas() {
    ...
    switch (gautiPasirinkima()) {
        case 1:
            cout << "Pasirinkote: Prideti nauja paskyra" << endl;
            break;
        case 2:
            cout << "Pasirinkote: Perziureti visas paskyras" << endl;
            break;
        case 3:
            cout << "Pasirinkote: Iseiti is programos" << endl;
            break;
        default:
